...
export default function Timer() {
	...
	return (
		<div>
			{showTimer ? (
				<div className=' flex items-center gap-2 bg-zinc-700 text-white p-1 sm:px-1 rounded-md text-sm font-medium
                hover:text-zinc-900 hover:bg-zinc-400 hover:shadow-lg transition duration-300 ease-in-out cursor-pointer'>
				...
				<div
					className='flex items-center p-1 h-8 bg-zinc-700 text-white px-2 py-1 sm:px-4 rounded-md text-sm font-medium
                    hover:text-zinc-900 hover:bg-zinc-400 hover:shadow-lg transition duration-300 ease-in-out cursor-pointer'
